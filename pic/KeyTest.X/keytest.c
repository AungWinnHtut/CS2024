...
void main(void) {
    ...
    TRISD =  0b11110000; //input 1, output 0
    WPUD = 0xF0; //internal pullup 1, 
    LCD_Clear();
    while (1) {
        ...
        if (key != '\0') {
            ...
            LCD_Char(key);
            switch(key){
                case '1': analog_choice = 3; LCD_String(" Oxygen"); break;//oxygen RA3
                case '2': analog_choice = 6; LCD_String(" Temperature");break;//temperature RA6
            }
        }
        if(PORTAbits.RA0 == 0)
        {
...
char keypad_scanner() {
    ...
    if(C_1==0) { __delay_ms(10); return '1'; }
    if(C_2==0) { __delay_ms(10); while(C_2==0); return '2'; }
    if(C_3==0) { __delay_ms(10); while(C_3==0); return '3'; }
    if(C_4==0) { __delay_ms(10); while(C_4==0); return 'F'; }
    
    R_2=0; R_1=1; R_3=1; R_4=1;
    if(C_1==0) { __delay_ms(10); while(C_1==0); return '4'; }
    if(C_2==0) { __delay_ms(10); while(C_2==0); return '5'; }
    if(C_3==0) { __delay_ms(10); while(C_3==0); return '6'; }
    if(C_4==0) { __delay_ms(10); while(C_4==0); return 'E'; }
     
    R_3=0; R_1=1; R_2=1; R_4=1;
    if(C_1==0) { __delay_ms(10); while(C_1==0); return '7'; }
    if(C_2==0) { __delay_ms(10); while(C_2==0); return '8'; }
    if(C_3==0) { __delay_ms(10); while(C_3==0); return '9'; }
    if(C_4==0) { __delay_ms(10); while(C_4==0); return 'D'; }
      
    R_4=0; R_2=1; R_3=1; R_1=1;
    if(C_1==0) { __delay_ms(10); while(C_1==0); return 'A'; }
    if(C_2==0) { __delay_ms(10); while(C_2==0); return '0'; }
    if(C_3==0) { __delay_ms(10); while(C_3==0); return 'B'; }
    if(C_4==0) { __delay_ms(10); while(C_4==0); return 'C'; }
